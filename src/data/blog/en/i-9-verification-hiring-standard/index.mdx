...
That leads to the more durable point. I-9 completion is one of the only compliance obligations a new hire can observe directly. It happens in the open, at onboarding, with a form and a document check. Nearly everything else an organization is required to get right, payroll accuracy, correct classification, wage and hour practices, happens entirely out of view of the person it affects most. This is a heuristic, not a proof, and it should be stated as one: a missing I-9 does not mechanically establish that pay is wrong or classification is off. But it is the one observable checkpoint available, and any operator worth the title weights the observable checkpoint they have rather than pretending it tells them nothing. Treating that single visible failure as noise, rather than signal, is itself a failure of judgment.

## The Standard Worth Holding, on Either Side of the Desk

The instinct here is not new to me. I have spent a decade evaluating and building the systems that sit behind a business, pipelines, data models, controls, where the discipline is in verifying the foundation before trusting anything built on top of it. A missing I-9 is a foundation problem wearing the costume of a paperwork problem, and the standard should apply the same way regardless of which side of the hiring table someone sits on.
